...
# Usciamo di un livello (da app/ a backend/) per pescare i file e le cartelle nella radice
from ..utils import get_password_hash, verify_password 
from ..database import get_db
from ..models import User
from ..db.crud import update_user_password_in_db  # Ora esce dalla cartella app e trova la cartella db
